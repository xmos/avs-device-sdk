...
void UIManager::printState() {
    ...
    system("/home/pi/sdk-folder/third-party/pi_hat_ctrl/pi_hat_ctrl SET_GPIO 11 0");
#endif
                return;
    ...
    system("/home/pi/sdk-folder/third-party/pi_hat_ctrl/pi_hat_ctrl SET_GPIO 11 1");
#endif
                return;
